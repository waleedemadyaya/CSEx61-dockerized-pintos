...
#define FIX_P 17                /* Number of integer bits. */
#define FIX_Q 14                /* Number of fractional bits. */
...
static inline int
fix_compare (Float_t x, Float_t y)
{
